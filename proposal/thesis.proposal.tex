...
An opcode matrix/table that maps an exception to a function call will then call em\_syscall when the CPU cannot execute the instruction, and when TCG is disabled. The following snippet is a portion of the opcode matrix/table:
